...
const monitorTaskSummary = require("../controllers/monitor/taskSummary");
...
function router(cache, db, path, conf) {
  ...
  basicRouter.get("/monitor/taskSummary", function(req, res) {
    monitorTaskSummary.handle(req, res, cache, db, path);
  });
